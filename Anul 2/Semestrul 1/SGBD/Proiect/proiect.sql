...
CREATE TABLE comanda (
    ...
    pret_preferential   NUMBER(10) NULL,
...
insert into comanda (id_comanda, id_client, id_factura, pret, pret_preferential)
values (id_comanda.nextval, 1, 4, 50, null); --1

insert into comanda (id_comanda, id_client, id_factura, pret, pret_preferential)
values (id_comanda.nextval, 3, 5, 130, null); --2

insert into comanda (id_comanda, id_client, id_factura, pret, pret_preferential)
values (id_comanda.nextval, 2, 3, 20, null); --3

insert into comanda (id_comanda, id_client, id_factura, pret, pret_preferential)
values (id_comanda.nextval, 4, 2, 230, null); --4

insert into comanda (id_comanda, id_client, id_factura, pret, pret_preferential)
values (id_comanda.nextval, 5, 1, 80, null); --5

insert into comanda (id_comanda, id_client, id_factura, pret, pret_preferential)
values (id_comanda.nextval, 1, 4, 100, null); --6
