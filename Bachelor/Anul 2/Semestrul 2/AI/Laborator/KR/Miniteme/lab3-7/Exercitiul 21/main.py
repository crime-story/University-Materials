...
class Joc:
    ...
    def linie_deschisa(self, lista, jucator):
        ...
        if not jo in lista: # daca nu am simbolul jucatorului opus in lista
            return lista.count(jucator) # returnez cate simboluri am pe linia respectiva
        # return 1
        return 0

    def linie_deschisa1(self, lista, jucator):
        scoruri = [2, 1, 2, 1, 4, 1, 2, 1, 2]
        scorJucatarCurent = 0
        for i in range(len(lista)):
            if lista[i] == Joc.JMIN:
                scorJucatarCurent -= scoruri[i]
            elif lista[i] == Joc.JMAX:
                scorJucatarCurent += scoruri[i]
        return scorJucatarCurent

    def linii_deschise(self, jucator):
        return self.linie_deschisa1(self.matr[0:3], jucator) + self.linie_deschisa1(self.matr[3:6],
                                                                                  jucator) + self.linie_deschisa1(
            self.matr[6:9], jucator) + self.linie_deschisa1(self.matr[0:9:3], jucator) + self.linie_deschisa1(
            self.matr[1:9:3], jucator) + self.linie_deschisa1(self.matr[2:9:3], jucator) + self.linie_deschisa1(
            self.matr[0:9:4], jucator) + self.linie_deschisa1(self.matr[2:7:2], jucator)
    ...
    def estimeaza_scor(self, adancime):
        ...
        if t_final == self.__class__.JMAX:  # self.__class__ referinta catre clasa instantei
            ...
            scoruri = [2, 1, 2, 1, 4, 1, 2, 1, 2]
            scorJucatarCurent = 0
            for i in range(self.NR_COLOANE*3):
                if self.matr[i] == Joc.JMIN:
                    scorJucatarCurent -= scoruri[i]
                elif self.matr[i] == Joc.JMAX:
                    scorJucatarCurent += scoruri[i]
            return scorJucatarCurent
