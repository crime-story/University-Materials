...
class Graph:  # graful problemei
    ...
    def calculeaza_h(self, infoNod, tip_euristica="euristica banala"):
        if tip_euristica == "euristica banala":
            ...
            # calculez cate blocuri nu sunt la locul fata de fiecare dintre starile scop, si apoi iau minimul dintre aceste valoriA
            h = 0
            nr_stive = 0
            nr_elemente_configuratie = 0

            for iStiva, stiva in enumerate(infoNod):
                nr_stive += 1
                for iElem, elem in enumerate(stiva):
                    nr_elemente_configuratie += 1

            media = nr_elemente_configuratie // nr_stive
...
nrSolutiiCautate = 3
a_star(gr, nrSolutiiCautate=3, tip_euristica="euristica admisibila robertto")
