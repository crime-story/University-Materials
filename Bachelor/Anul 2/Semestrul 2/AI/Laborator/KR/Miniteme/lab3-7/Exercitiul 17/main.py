...
class Graph:  # graful problemei
    ...
    def testeaza_scop(self, nodCurent):
        # initial aveam nodCurent.info[0]==nodCurent.info[1]==nodCurent.info[2]==0 adica
        # toti misionarii si toti canibalii erau pe malul drept si barca era pe malul final(adica malul drept)

        return nodCurent.info[0] == Graph.N and nodCurent.info[1] == 0  # toti canibalii sa fie pe malul
        # stang(malul initial) si toti misionarii pe malul drept(malul final)

    # pe malul stang sa fie N canibali si 0 misionari
