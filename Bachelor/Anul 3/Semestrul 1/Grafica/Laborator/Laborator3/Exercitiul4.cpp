...
void RenderFunction(void)
{
	...
	matrDepl = glm::translate(glm::mat4(1.0f), glm::vec3(0.0, 0.0, 0.0)); // plaseaza patratul rosu
	matrScale1 = glm::scale(glm::mat4(1.0f), glm::vec3(0.6, 0.6, 0.0)); // folosita la desenarea dreptunghiului albastru
	...
	myMatrix = resizeMatrix * matrTransl * matrRot * matrDepl ;
	// Culoarea
	codCol = 2;
	// Transmitere variabile uniforme
	glUniformMatrix4fv(myMatrixLocation, 1, GL_FALSE, &myMatrix[0][0]);
