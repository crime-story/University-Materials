...
void CreateVBO(void)
{
	...
	for (int n = 0; n < INSTANCE_COUNT; n++)
	{
		MatModel[n] = glm::translate(glm::mat4(1.0f), glm::vec3(80 * n * tan(10.f * n * 180 / PI), 80 * n * sin(10.f * n * 180 / PI), 80 * n * cos(10.f * n * 180 / PI))) * glm::rotate(glm::mat4(1.0f), n * PI / 8, glm::vec3(n, 2 * n * n, n / 3));
	}
