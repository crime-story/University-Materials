...
void CreateVBO(void)
{
	...
	GLfloat Vertices[] =
	{
		...
		50.0f,  -50.0f,  0.0f, 1.0f,   0.7f, 0.0f, 0.0f,
		50.0f,  50.0f,  0.0f, 1.0f,    0.5f, 0.0f, 0.0f,
		-50.0f,  50.0f, 0.0f, 1.0f,   0.1f, 0.0f, 0.0f,
	};
...
void RenderFunction(void)
{
	...
	glUniform1i(codColLocation, codCol);
	glLineWidth(3.5);
	glDrawElements(GL_LINE_LOOP, 5, GL_UNSIGNED_BYTE, (void*)(17));
	glDrawElements(GL_LINE_LOOP, 8, GL_UNSIGNED_BYTE, (void*)(23));
